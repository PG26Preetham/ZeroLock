...
void UZeroBaseCharacterMovementComp::OnMovementModeChanged(EMovementMode PreviousMovementMode,
...
{
	if (Proxy_bWallBounce)
	{
		if (WallBounceDelegate.IsBound())
		{
...
void UZeroBaseCharacterMovementComp::Server_EnterZipline_Implementation(USplineComponent* ZiplineToUse,
	bool InSplineDir)
{
...
bool UZeroBaseCharacterMovementComp::IsServer() const
{
	return CharacterOwner->HasAuthority();
}

float UZeroBaseCharacterMovementComp::CapR() const
{
	return CharacterOwner->GetCapsuleComponent()->GetScaledCapsuleRadius();
}

float UZeroBaseCharacterMovementComp::CapHH() const
{
	return CharacterOwner->GetCapsuleComponent()->GetScaledCapsuleHalfHeight();
}

bool UZeroBaseCharacterMovementComp::IsMovementMode(EMovementMode inMovementMode) const
{
	return inMovementMode == MovementMode;
}

FVector UZeroBaseCharacterMovementComp::CharLocation() const
{
	return UpdatedComponent->GetComponentLocation();
}

FRotator UZeroBaseCharacterMovementComp::CharRotation() const
{
	return UpdatedComponent->GetComponentRotation();
}

FVector UZeroBaseCharacterMovementComp::CamFV() const
{
	return ZeroCharacter_Owner->GetFollowCamera()->GetForwardVector();
}

FVector UZeroBaseCharacterMovementComp::CamLoc() const
{
	return ZeroCharacter_Owner->GetFollowCamera()->GetComponentLocation();
}
FQuat UZeroBaseCharacterMovementComp::CamQuat() const
{
...
void UZeroBaseCharacterMovementComp::GetLifetimeReplicatedProps(
