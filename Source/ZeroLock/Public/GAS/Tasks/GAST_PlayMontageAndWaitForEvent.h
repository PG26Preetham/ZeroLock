...
#include "GAST_PlayMontageAndWaitForEvent.generated.h"
 ...
 */
UCLASS()
class ZEROLOCK_API UGAST_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
	...
	UGAST_PlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	static UGAST_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
